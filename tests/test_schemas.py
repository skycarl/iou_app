...
def test_entry_base():
    entry_dict = {"sender": "Alice", "recipient": "Bob", "amount": 23.99}
...
def test_entry_create():
    entry_dict = {"sender": "Bob", "recipient": "Alice", "amount": 52.01, "description": "Brunch"}
...
def test_entry():
    entry_dict = {"id": 1, "sender": "Alice", "recipient": "Bob", "amount": 23.99, "description": "Dinner"}
